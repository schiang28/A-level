...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label2 = ttk.Label(
            self,
            text="Sudoku is considered highly addictive\nbut since there aren’t any harmful side effects\ngo right ahead and get addicted!",
            font=("Bold", 20),
        )
        label2.place(x=600, y=300)
        button1 = ttk.Button(
            self, text="Let's Play", command=lambda: controller.show_frame(PageOne)
        )
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label1 = ttk.Label(
            self, text="Enter your Name :", font=LARGE_FONT, style="BW.TLabel"
        )
        ...
        label2 = ttk.Label(
            self,
            text="Please select the level of difficulty :",
            font=("Verdana", 20),
            style="BW.TLabel",
        )
        ...
        choice_button1 = ttk.Radiobutton(
            self,
            text=difficulty[0][0],
            variable=choice,
        ...
        choice_button2 = ttk.Radiobutton(
            self,
            text=difficulty[1][0],
            variable=choice,
            command=lambda: ShowChoice(),
            value=difficulty[1][1],
        )
        choice_button2.place(x=50, y=rad_y + 35)

        choice_button3 = ttk.Radiobutton(
            self,
            text=difficulty[2][0],
            variable=choice,
            command=lambda: ShowChoice(),
        ...
        choice_button4 = ttk.Radiobutton(
            self,
            text=difficulty[3][0],
            variable=choice,
            command=lambda: ShowChoice(),
            value=difficulty[3][1],
        )
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label1 = ttk.Label(
            self,
            text="While solving Sudoku puzzles can be significant challenge, the rules for traditional solution finding are quite straight forward.\n\n1. Each row, column, and nonet can contain each number (typically 1 to 9) exactly once.\n\n2. For traditional Sudoku puzzles featuring the numbers 1 to 9, this sum is equal to 45.\n\n3. In order to solve Sudoku puzzles reliably,you must be disciplined, focused, and patient.",
            font=("Bold", 20),
        )
        ...
        label2 = ttk.Label(
            self,
            text="4. If you enter more than one number then only the first number will be considered for evaluation.",
            font=("Bold", 20),
        )
